...
public interface IGeneralMessage : IMessage
{
    ...
    public static string CreateMessageBody(bool openingPosition, bool allowingParallelPositions, bool closingAllPositions, string direction, decimal slPrice, decimal? tpPrice = null)
    {
