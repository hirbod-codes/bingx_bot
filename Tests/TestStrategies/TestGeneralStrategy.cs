...
public class TestGeneralStrategy
{
    ...
    public async Task TestCheckClosePosition()
    {
        ...
        result = await generalStrategy.CheckClosePositionSignal(isLastOpenPositionLong);
        Assert.False(result);
    ...
    public async Task TestCheckOpenPosition()
    {
        ...
        result = await generalStrategy.CheckOpenPositionSignal(isLastOpenPositionLong);
        Assert.False(result);
