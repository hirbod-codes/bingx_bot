...
public class RiskManagement : IRiskManagement
{
    ...
    public async Task<bool> IsPositionAcceptable(decimal entryPrice, decimal slPrice)
    {
        ...
        decimal grossLoss = PnLAnalysis.src.PnLAnalysis.GetGrossLoss(closedPositionsForLoss) + openedPositionsMaximumLoss;
        ...
        decimal grossProfit = Math.Abs(grossLoss - PnLAnalysis.src.PnLAnalysis.GetGrossProfit(closedPositionsForProfit));
